...
namespace PhobiaX.Game.GameLoops
{
	public class GameLoopFactory
	{
		...
		public GameLoop CreateGameLoop()
		{
			...
			var player1 = new PlayerGameObject(new AnimatedCollection(playerAnimatedSet), new AnimatedCollection(effectsAnimatedSet));
			var player2 = new PlayerGameObject(new AnimatedCollection(playerAnimatedSet), new AnimatedCollection(effectsAnimatedSet));
